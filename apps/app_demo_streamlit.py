...
with st.spinner('Loading model...'):
    model = tmt.create_model("mdl.keras")
...
if uploaded_file is not None:
    ...
    with st.spinner('Extracting features...'):
        song_img = tmt.song_to_img(uploaded_file)
        r,g,b = tmt.split_rgb(song_img)
    ...
    with st.spinner('Loading predictions...'):
        results = tmt.get_genre_prediction(model, song_img, 0.85)
